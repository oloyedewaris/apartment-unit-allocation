    ...
    <div className="unit-page">
      ...
      <aside className="sales-panel">
        ...
        <section>
          ...
          <h2>Ask about this unit</h2>
          <p>Get the full specification, payment schedule and availability confirmation from our sales team.</p>
          <a className="primary-button" href={`mailto:voltaskai@endover.ee?subject=Volta SKAI unit ${unit.number}`}>
            Request information
          </a>
          {unit.booking_url && (
            <a className="secondary-button" href={unit.booking_url}>
              Online reservation
            </a>
          )}
        </section>
