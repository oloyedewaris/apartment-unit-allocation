      ...
      <aside className="sales-panel">
        ...
        <section className="sales-contact">
          ...
          {salesData.map((sale) => (
            <div key={sale.name} className="contact-card">
              ...
              <div className="contact-actions">
                ...
                <a className="contact-action" href={`mailto:${sale.email}?subject=${salesSubject}`} aria-label="Email Myxellia Sales">
                  ✉
                </a>
              </div>
            </div>
          ...
          <a
            ...
            href={`mailto:?subject=${encodeURIComponent(`Myxellia unit ${unit.number}`)}&body=${encodeURIComponent(`Take a look at Myxellia unit ${unit.number}: /units/${unit.number_num}`)}`}
          >
            Send to a friend
          </a>
        </section>
